package com.example.demotbkend.controller;
...
import com.example.demotbkend.model.Produto;
import com.example.demotbkend.repository.ProdutoRepository;
...
public class ProdutoController {
	...
	public ResponseEntity<?> update(@PathVariable("id") long id, @RequestBody Produto produto) {
		return repository.findById(id).map(record -> {
			record.setName(produto.getName());
